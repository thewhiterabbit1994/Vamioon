    ...
    <div>
      <div className="flex justify-between items-center h-[5.15625vw] w-[89vw] absolute mr-[9vw] mt-[5vw]">
        ...
        <div className="w-[26vw] flex  justify-between">
          <div className="flex cursor-pointer text-[#026155]  rounded-[0.7vw] ml-[-1vw] px-[2.5vw] py-[1.2vw] text-[1vw] ">
          ...
          <div className="flex cursor-pointer font-bold text-[#AC5E24] bg-[#FCDBC2] rounded-[0.7vw]  px-[1vw] py-[1.2vw] text-[1vw] ">
