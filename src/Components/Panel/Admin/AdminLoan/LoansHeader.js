...
export default () => {
  ...
  const [ModalReminderOfPaymentDeadline, setModalReminderOfPaymentDeadline] =
    useState(false);
  return (
    <div>
      <AddNewLoan
        ModalNewLoan={ModalNewLoan}
        setModalNewLoan={setModalNewLoan}
      />
      <ReminderOfPaymentDeadline
        ModalReminderOfPaymentDeadline={ModalReminderOfPaymentDeadline}
        setModalReminderOfPaymentDeadline={setModalReminderOfPaymentDeadline}
      />
