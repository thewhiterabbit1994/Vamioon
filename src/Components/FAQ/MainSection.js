              ...
              <section
                ...
                <div
                  ...
                  <div className={`${item.isOpen === true ? "w-[39.53147877013177vw] h-[3.6603221083455346vw] flex flex-col justify-between items-center" : "w-[39.53147877013177vw] flex-col h-[17.569546120058565vw] flex justify-between items-centr"} `}>
                    <div className={`${item.isOpen === true ? " flex flex-col items-center pr-[0.7320644216691069vw] border-[0.20vw] h-[17.569546120058565vw] border-[#00693B] rounded-[0.58vw]" : " flex flex-col items-center pr-[0.7320644216691069vw]"} `}>
