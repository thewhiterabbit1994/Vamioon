                    ...
                    >
                      ...
                      >
                        <div className="flex justify-between w-[37.33528550512445vw]  my-[0.7320644216691069vw]">
                          <div className="flex items-center pr-[1.4641288433382138vw] ">
                            <p
                              className={`${
                                !item.isOpen === true
                                  ? "w-[0.7320644216691069vw] h-[0.7320644216691069vw] rounded-[50%] bg-[#C4C4C4]"
                                  : "w-[0.7320644216691069vw] h-[0.7320644216691069vw] rounded-[50%] bg-[#00AF63]"
                              } `}
                            ></p>
                            <p
                              className={`${
                                !item.isOpen === true
                                  ? " flex justify-end items-center pr-[1.4641288433382138vw] h-[2.9282576866764276vw]"
                                  : "flex justify-end items-center pr-[1.4641288433382138vw] h-[2.9282576866764276vw]"
                              }`}
                            >
                              {item.question}{" "}
                          ...
                          <p
                            ...
                            className={`${
                              !item.isOpen === true
                                ? "text-[1.4641288433382138vw] pl-[2.1961932650073206vw] pt-[1.0980966325036603vw] cursor-pointer"
                                : "hidden"
                            } `}
                          >
                            <ArrowDown />
                        ...
                        <div
                          className={`${
                            item.isOpen === true
                              ? "w-[34.40702781844802vw] h-[0.14641288433382138vw] rounded-lg bg-[#c4c4c469]"
                              : " hidden"
                          } `}
                        ></div>
                        <p
                        ...
                        >
                          لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به
                          متنی آزمایشی و بی‌معنی در صنعت چاپ، صفحه‌آرایی و طراحی
                          گرافیک گفته می‌شود. طراح گرافیک از این متن به عنوان
                          عنصری از ترکیب بندی برای پر کردن صفحه و ارایه اولیه
                          شکل ظاهری و کلی طرح سفارش گرفته شده استفاده می نماید،
                          تا از نظر گرافیکی نشانگر چگونگی نوع و اندازه فونت و
                          ظاهر متن باشد. معمولا طراحان گرافیک برای صفحه‌آرایی،
                          نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند تا
                          صرفا به مشتری یا صاحب کار خود نشان دهند که صفحه
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          className={`${
                            item.isOpen === true
                              ? "w-[35.13909224011713vw] text-justify flex justify-end  h-[200px] leading-6 pt-[1.0980966325036603vw]"
                              : "hidden"
                          }`}
                        >
                          لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به
